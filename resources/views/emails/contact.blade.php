                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tr>
                                        <td align="center"
                                            style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            <div
                                                style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:24px;font-weight:bold;line-height:22px;text-align:center;color:#333;">
                                    ...
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <div
                                                style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:14px;line-height:22px;text-align:left;color:#333;">
                                                <p>Alguien se ha puesto en contacto a través del sitio web <a href="{{ env('APP_URL') }}">Hapec.com.mx</a>. A continuación los detalles del nuevo mensaje.</p>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word; border-top:1px solid #ecedee;">
                                            <table 0="[object Object]" 1="[object Object]" 2="[object Object]"
                                                ...
                                                <tr>
                                                    <td style="padding: 0px 15px 10px 0;">{{ $data['name'] }}</td>
											...
											<table 0="[object Object]" 1="[object Object]" 2="[object Object]"
                                                ...
                                                <tr>
                                                    <td style="padding: 0px 15px 10px 0;">{{ $data['email'] }}</td>
                                                    <td style="padding: 0 15px;"></td>
                                                    <td style="padding: 0 0 0 15px;" align="right"></td>
                                                </tr>
                                            </table>
											...
											<table 0="[object Object]" 1="[object Object]" 2="[object Object]"
                                                ...
                                                <tr>
                                                    <td style="padding: 0px 15px 10px 0;">{{ $data['phone'] }}</td>
                                                    <td style="padding: 0 15px;"></td>
                                                    <td style="padding: 0 0 0 15px;" align="right"></td>
                                                </tr>
                                            </table>
											...
											<table 0="[object Object]" 1="[object Object]" 2="[object Object]"
                                                ...
                                                <tr>
                                                    <td style="padding: 0px 15px 10px 0;">{{ $data['message'] }}</td>
                                                    <td style="padding: 0 15px;"></td>
                                                    <td style="padding: 0 0 0 15px;" align="right"></td>
                                                </tr>
                                            </table>
                                                    ...
                                                    <tr>
                                                        <td align="center"
                                                            ...
                                                            <div
                                                                ...
                                                                Álvaro Obregón 327 Centro, Monterrey, N.L.
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="center"
                                                            ...
                                                            <div
																...
																info@hapec.com.mx | (81) 1038 2831<br>
																Hapec {{ Carbon\Carbon::now()->year }} &copy;
                                                            </div>
